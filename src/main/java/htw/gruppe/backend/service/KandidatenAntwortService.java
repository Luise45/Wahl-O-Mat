...
public class KandidatenAntwortService {
    ...
    public List<KandidatenAntwortenDto> getKandidatenAntwort(Long kandidatId) {
        return kandidatenAntwortRepository.findByKandidatId(kandidatId).stream()
     ...
     */
    public KandidatenAntwortenResponseDto postKandidatenAntwort(KandidatenAntwortenRequestDto request, String Matrikelnummer) {
        ...
        /**
         * antwort kombinert den kandidaten von Login, aussage und die Antwort der Aussage
         */
